            ...
            <Card >
                ...
                <Card.Body>
                    ...
                    <Card.Text> 
                        ...
                        {showAdded ? <Button variant="primary" onClick={(e)=>favouritesClicked()}>+ Favourite (added)</Button> : <Button variant="outline-primary" onClick={(e)=>favouritesClicked()}>+ Favourite</Button>}
                    </Card.Text>
                </Card.Body>
            </Card>
            </>
